...
namespace ns3 {
	...
	PPBPApplication::PPBP() // Poisson Pareto Burst
	{
		...
		pareto->SetAttribute ("Scale", DoubleValue (m_timeSlot.GetSeconds())); // right version
//                pareto->SetAttribute ("Scale", DoubleValue (m_burstLength->GetValue ())); // wrong original version
