...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry (const Ipv6Address &mDest,
                                              const Ipv6Prefix &mDestNetworkPrefix,
                                              const Ipv6Address &mGateway, uint32_t mInterface,
                                              const Ipv6Address &mPrefixToUse, bool mIsTranslation)
    : m_dest (mDest),
      m_destNetworkPrefix (mDestNetworkPrefix),
      m_gateway (mGateway),
      m_interface (mInterface),
      m_prefixToUse (mPrefixToUse),
      m_isTranslation (mIsTranslation)
{
}

Ipv6RoutingTableEntry::Ipv6RoutingTableEntry (const Ipv6Address &mDest,
                                              const Ipv6Prefix &mDestNetworkPrefix,
                                              const Ipv6Address &mGateway, uint32_t mInterface, bool mIsTranslation)
    : m_dest (mDest),
      m_destNetworkPrefix (mDestNetworkPrefix),
      m_gateway (mGateway),
      m_interface (mInterface),
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry (const Ipv6Address &mDest,
                                              const Ipv6Prefix &mDestNetworkPrefix,
                                              uint32_t mInterface, bool mIsTranslation)
    : m_dest (mDest),
      m_destNetworkPrefix (mDestNetworkPrefix),
      m_gateway (Ipv6Address::GetZero ()),
      m_interface (mInterface),
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry (const Ipv6Address &mDest,
                                              const Ipv6Prefix &mDestNetworkPrefix,
                                              uint32_t mInterface,
                                              const Ipv6Address &mPrefixToUse,
                                              bool mIsTranslation)
    : m_dest (mDest),
      m_destNetworkPrefix (mDestNetworkPrefix),
      m_gateway (Ipv6Address::GetZero ()),
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry (const Ipv6Address &mDest,
                       const Ipv6Prefix &mDestNetworkPrefix,
                       uint32_t mInterface, bool mIsTranslation,Ipv6Prefix iviPrefix)
    : m_dest (mDest),
      m_destNetworkPrefix (mDestNetworkPrefix),
      m_gateway (Ipv6Address::GetZero ()),
      m_interface (mInterface),
      m_prefixToUse (Ipv6Address ("::")),
      m_isTranslation (mIsTranslation),
      m_iviPrefix(iviPrefix)
{

}

bool
Ipv6RoutingTableEntry::IsTranslation () const
{
  return m_isTranslation;
}
Ipv6RoutingTableEntry
Ipv6RoutingTableEntry::CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix,
                                             Ipv6Address nextHop, uint32_t interface,
                                             bool isTranslation)
{
  return Ipv6RoutingTableEntry (network, networkPrefix, nextHop, interface,isTranslation);;
}
Ipv6RoutingTableEntry
Ipv6RoutingTableEntry::CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix,
                                             Ipv6Address nextHop, uint32_t interface,
                                             Ipv6Address prefixToUse, bool isTranslation)
{
  return Ipv6RoutingTableEntry (network, networkPrefix, nextHop, interface,prefixToUse,isTranslation);;
}
...
Ipv6RoutingTableEntry::CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix,
                                             ...
                                             bool isTranslation)
{
  return Ipv6RoutingTableEntry (network, networkPrefix, interface,isTranslation);;
}

Ipv6RoutingTableEntry
Ipv6RoutingTableEntry::CreateIVINetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix,
                                             uint32_t interface,
                                             bool isTranslation,Ipv6Prefix iviPrefix)
{
  return Ipv6RoutingTableEntry (network, networkPrefix, interface,isTranslation,iviPrefix);
}
...
void
Ipv6RoutingTableEntry::SetIviPrefix (const Ipv6Prefix &mIviPrefix)
{
  m_iviPrefix = mIviPrefix;
}
const Ipv6Prefix &
Ipv6RoutingTableEntry::GetIviPrefix () const
{
  return m_iviPrefix;
}
