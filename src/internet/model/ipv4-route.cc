 ...
 */
void
Ipv4Route::SetSrcPrefixAddr (const Ipv6Address &srcPrefixAddr)
{
  NeedTranslation();
  Ipv4Route::srcPrefixAddr = srcPrefixAddr;
}
void
Ipv4Route::SetDstPrefixAddr (const Ipv6Address &dstPrefixAddr)
{
  NeedTranslation();
  DstPrefixAddr = dstPrefixAddr;
}
void
Ipv4Route::SetSrcPrefix (const Ipv6Prefix &srcPrefix)
{
  NeedTranslation();
  Ipv4Route::srcPrefix = srcPrefix;
}
void
Ipv4Route::SetDstPrefix (const Ipv6Prefix &dstPrefix)
{
  NeedTranslation();
  Ipv4Route::dstPrefix = dstPrefix;
}
Ipv6Address
Ipv4Route::GetSrcPrefixAddr () const
{
  return srcPrefixAddr;
}
Ipv6Address
Ipv4Route::GetDstPrefixAddr () const
{
  return DstPrefixAddr;
}
Ipv6Prefix
Ipv4Route::GetSrcPrefix () const
{
  return srcPrefix;
}
Ipv6Prefix
Ipv4Route::GetDstPrefix () const
{
  return dstPrefix;
}
bool
Ipv4Route::IsTranslation (void) const
{
  return m_isTranslation;
}
void
Ipv4Route::NeedTranslation (void)
{
  if (!m_isTranslation){
