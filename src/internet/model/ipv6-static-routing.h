...
public:
   ...
   * \param metric metric of route in case of multiple routes to same destination
   */
  void AddNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, Ipv6Address nextHop, uint32_t interface, uint32_t metric = 0,bool isTranslation=false);
   ...
   * \param metric metric of route in case of multiple routes to same destination
   */
  void AddNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, Ipv6Address nextHop, uint32_t interface, Ipv6Address prefixToUse, uint32_t metric = 0,bool isTranslation=false);
   ...
   * \param metric metric of route in case of multiple routes to same destination
   */
  void AddNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, uint32_t interface, uint32_t metric = 0,bool isTranslation=false);
  ...
  void AddIVINetworkRouteTo(Ipv6Address network,Ipv6Prefix networkPrefix, Ipv6Prefix iviPrefix,uint32_t interface,uint32_t metric =0, bool isTranslation = true);
