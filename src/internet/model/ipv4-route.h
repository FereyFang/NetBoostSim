...
public:
  ...
  Ipv6Address GetSrcPrefixAddr () const;
  Ipv6Address GetDstPrefixAddr () const;
  Ipv6Prefix  GetSrcPrefix () const;
  Ipv6Prefix  GetDstPrefix () const;

  void SetSrcPrefixAddr (const Ipv6Address &srcPrefixAddr);
  void SetDstPrefixAddr (const Ipv6Address &dstPrefixAddr);
  void SetSrcPrefix (const Ipv6Prefix &srcPrefix);
  void SetDstPrefix (const Ipv6Prefix &dstPrefix);
