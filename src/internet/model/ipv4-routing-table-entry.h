...
public:
   ...
   * IVI getter
   */
  Ipv6Address GetSrcIpv6Address(void) const;
  Ipv6Address GetDstIpv6Address(void) const;
  Ipv6Prefix GetSrcIpv6Prefix(void) const;
  Ipv6Prefix GetDstIpv6Prefix(void) const;
   ...
   */
  static Ipv4RoutingTableEntry CreateHostRouteTo (Ipv4Address dest, Ipv4Address nextHop,
                                                  uint32_t interface);
  /**
   * \return An Ipv4RoutingTableEntry object corresponding to the input parameters.
   * \param dest Ipv4Address of the destination
   ...
   * \param interface Outgoing interface 
   */
  static Ipv4RoutingTableEntry CreateNetworkRouteTo (Ipv4Address network, Ipv4Mask networkMask,
  ...
  static Ipv4RoutingTableEntry CreateHostRouteTo (Ipv4Address dest,
                                                  Ipv4Address nextHop,
                                                  uint32_t interface,
                                                  Ipv6Address srcPrefixAddr,
                                                  Ipv6Address dstPrefixAddr,
                                                  Ipv6Prefix srcPrefix,
...
private:
   ...
   * IVI constructor
   */
  Ipv4RoutingTableEntry (const Ipv4Address &mDest, const Ipv4Address &mGateway, uint32_t mInterface,
                         const Ipv6Address &srcPrefixAddr, const Ipv6Address &dstPrefixAddr,
                         const Ipv6Prefix &srcPrefix, const Ipv6Prefix &dstPrefix);
  Ipv4RoutingTableEntry (const Ipv4Address &mDest, uint32_t mInterface,
                         const Ipv6Address &srcPrefixAddr, const Ipv6Address &dstPrefixAddr,
                         const Ipv6Prefix &srcPrefix, const Ipv6Prefix &dstPrefix);
  Ipv4RoutingTableEntry (const Ipv4Address &mDest, const Ipv4Mask &mDestNetworkMask,
                         const Ipv4Address &mGateway, uint32_t mInterface,
                         const Ipv6Address &srcPrefixAddr, const Ipv6Address &dstPrefixAddr,
                         const Ipv6Prefix &srcPrefix, const Ipv6Prefix &dstPrefix);
  Ipv4RoutingTableEntry (const Ipv4Address &mDest, const Ipv4Mask &mDestNetworkMask,
                         uint32_t mInterface, const Ipv6Address &srcPrefixAddr,
                         const Ipv6Address &dstPrefixAddr, const Ipv6Prefix &srcPrefix,
...
private:
   ...
   */
  Ipv4MulticastRoutingTableEntry (Ipv4Address origin, Ipv4Address group, uint32_t inputInterface,
                                  std::vector<uint32_t> outputInterfaces);
