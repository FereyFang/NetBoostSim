...
public:
  ...
  const Ipv6Prefix &GetIviPrefix () const;
  void SetIviPrefix (const Ipv6Prefix &mIviPrefix);
  ...
  static Ipv6RoutingTableEntry CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, Ipv6Address nextHop, uint32_t interface,bool isTranslation);
  static Ipv6RoutingTableEntry CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, Ipv6Address nextHop, uint32_t interface, Ipv6Address prefixToUse,bool isTranslation);
  static Ipv6RoutingTableEntry CreateNetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, uint32_t interface,bool isTranslation);
  static Ipv6RoutingTableEntry CreateIVINetworkRouteTo (Ipv6Address network, Ipv6Prefix networkPrefix, uint32_t interface,bool isTranslation,Ipv6Prefix iviPrefix);
...
private:
  ...
  Ipv6RoutingTableEntry (const Ipv6Address &mDest, const Ipv6Prefix &mDestNetworkPrefix,
                         const Ipv6Address &mGateway, uint32_t mInterface,
                         const Ipv6Address &mPrefixToUse, bool mIsTranslation);

  Ipv6RoutingTableEntry (const Ipv6Address &mDest,
